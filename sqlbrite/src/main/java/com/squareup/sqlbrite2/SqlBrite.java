...
public final class SqlBrite {
  ...
  @CheckResult @NonNull public BriteDatabase wrapDatabaseHelper(@NonNull Context context,@NonNull SQLiteOpenHelper helper,
    ...
    return new BriteDatabase(context,helper, password.toCharArray(),logger, triggers, triggers, scheduler, queryTransformer);
  }

    @CheckResult @NonNull public BriteDatabase wrapDatabaseHelper(@NonNull Context context,@NonNull SQLiteOpenHelper helper,
                                                                  @NonNull char[] password,@NonNull Scheduler scheduler) {
      PublishSubject<Set<String>> triggers = PublishSubject.create();
        return new BriteDatabase(context,helper, password, logger,  triggers, triggers,scheduler, queryTransformer);
    }
